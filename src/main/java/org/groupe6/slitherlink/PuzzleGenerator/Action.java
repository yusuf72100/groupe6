...
public class Action implements Serializable {
  ...
  private CelluleData.ValeurCote ancienneValeurCote; // ancienne valeur du cote
  private CelluleData.ValeurCote nouvelleValeurCote; // nouvelle valeur du cote

  // Constructeur de la classe Action
  public Action(CelluleData cellule1, CelluleData cellule2, int coteCellule1, CelluleData.ValeurCote nouvelleValeurCote) {
