...
public class Diagonales03 extends TechniquePattern3 {
  ...
  /**
   * Instance unique de la classe Diagonales03
   */
   ...
   * @return un ResultatTechnique à vrai si la méthode a détecté un schema incomplet sur deux 3 positionnés de manière diagonal.
   */
  @Override
