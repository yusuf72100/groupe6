...
public class Main extends Application {
  ...
  /**
   * Méthode statique pour reset le grid à null quand on a fini une partie
   */
  ...
  public static boolean afficherPopUpChoixOuiNon(String title, String headerTexte, String contentTexte) {
    ...
    alert.showAndWait().ifPresent(type -> {
      resultat.set(type == ButtonType.OK);
    });
  ...
  /**
   * Méthode statique pour afficher une pop-up d'information sur une technique
   *
   * @param nomSyliseTechnique le nom stylisé de la technique
   * @param techniqueName le nom de la technique
   * @param difficulteTechnique la difficulté de la technique
  ...
  public static void afficherPopUpInfoTechnique(
    ...
    try (BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream(cheminTxtTechnique), StandardCharsets.UTF_8))) {
      String line;
