...
/**
 * Classe qui correspond à l'interface graphique de l'historique des aides
 *
 * @author Yusuf
 */
public class HistoriqueAidesArea {
   ...
   */
  private final GridMenu gridMenu;
  ...
  /**
   * Boîte vertical qui contient les éléments de l'historique des aides
   */
  private final VBox elementsBox;

  /**
   * Constructeur de la classe HistoriqueAidesArea
   *
   * @param gridMenu le GridMenu qui contient l'historique des aides
  ...
  /**
   * Montrer les coordonnées de la technique
   *
   * @param coordonnees les coordonnées de la technique
   * @param nomSyliseTechnique le nom stylisé de la technique
   */
  private void montrerCoordonneesTechnique(Set<Coordonnee> coordonnees, String nomSyliseTechnique) {
    ...
    for ( Coordonnee coord : coordonnees ) {
      GridMenu.highlightCellule(coord.getY(), coord.getX(), "highlight-blue", "bg_custom-blue");
  ...
  /**
   * Mettre à jour l'affichage du bouton upgrade
   *
   * @param lvl le niveau de l'aide
   * @param upgradeHelp le bouton upgrade
   * @param eye_opened l'état de l'oeil
   * @return l'état de l'oeil
   */
