...
/**
 * Classe qui représente le menu de profil
 *
 * @author Yusuf
 */
public class ProfileMenu implements Menu {
  ...
  /**
   * Le AnchorPane du menu
   */
  private static AnchorPane anchorPane;

  /**
   * La boîte verticale du profil
   */
  private static VBox profilVbox;

  /**
   * La boîte horizontale du profil
   */
  ...
  /**
   * Le bouton du classement
   */
  private static Button classement;

  /**
   * Le stackPane du profil
   */
  private static StackPane content;

  /**
   * Le information du profil
   */
  private static Label[] description;

  /**
   * La boîte verticale de la description
   */
  ...
  /**
   * Le stackPane du classement
   */
  private static StackPane classementStack;

  /**
   * Initialisation du menu du profil
   *
   * @param w la largeur
   * @param h la hauteur
   */
  ...
  /**
   * Méthode qui retourne le menu du profil
   *
   * @param primaryStage la fenêtre principale
   * @param w la largeur
   * @param h la hauteur
   * @return le AnchorPane du menu
   */
